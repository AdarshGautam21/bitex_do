module.exports = function welcomeEmail(otpassword, appUrl) {
    return `<!doctype html>
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    
    <head>
      <title>Trillionbit</title>
      <!--[if !mso]><!-- -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                              <tr>
                                <td align="left" style="font-size:0px;padding:50px 25px 25px 25px;word-break:break-word;">
                                  <div class="titleWelcome" style="font-family:Lato, sans-serif;font-size:22px;font-weight:600;line-height:1;text-align:left;color:#000000;">Welcome to Trillionbit!</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Lato, sans-serif;font-size:16px;font-weight:500;line-height:22px;text-align:left;color:#535353;">Thank you for signing up! <br/> Now you can start trading cryptocurrencies on one of the Leading Digital Asset Exchanges in the world.</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Lato, sans-serif;font-size:16px;font-weight:500;line-height:22px;text-align:left;color:#535353;">In order to activate your account, please use the following OTP (One-time password): ${otpassword}</div>
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                              ...
                              <tr>
                                <td align="center" style="font-size:0px;padding:0px 25px;word-break:break-word;">
                                  <div style="font-family:Lato, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"><a href="mail:support@Trillionbit.com" style="text-decoration:none;color:#17294E;font-size:16px;font-weight:700;line-height:22px;"> support@Trillionbit.com </a></div>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center" style="font-size:0px;padding:0px 25px;word-break:break-word;">
                                  <div style="font-family:Lato, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"><a href="https://Trillionbit.com" style="text-decoration:none;color:#17294E;font-size:16px;font-weight:700;line-height:22px;"> www.Trillionbit.com </a></div>
                                </td>
                              </tr>
                            </table>
                          </td>

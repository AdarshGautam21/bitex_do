module.exports = function verifiedUndepositEmail() {
    return `<!doctype html>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                              <tr>
                                <td align="left" style="font-size:0px;padding:50px 25px 25px 25px;word-break:break-word;">
                                  <div class="titleWelcome" style="font-family:Lato, sans-serif;font-size:16px;font-weight:200;line-height:1;text-align:left;color:#000000;">Hello, </div>
                                </td>
                              </tr>
                              <tr>
                              
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Lato, sans-serif;font-size:16px;font-weight:500;line-height:22px;text-align:left;color:#535353;">Your account is verified and now you are one step closer to start trading. All you need to do is deposit funds in Bitex account and you will be able buy the cryptocurrency of your choice.</div>
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                              <tr>
                                <td align="center" style="font-size:0px;padding:0px;word-break:break-word;">
                                  <div style="font-family:Lato, sans-serif;font-size:16px;font-weight:400;line-height:28px;text-align:center;color:#535353;">
                                  Now you can start investing with the minimum value of 1000 INR or 200 AED and buy the coins of your choice.
                                  Please click on the below link For depositing the Fiat currency 
                                </td>
                              </tr>
                              <tr>
                                <td align="center" style="word-break:break-word;">
                                  <a style="margin: 10px 10px 10px 10px;font-size:15px;background-color:#17294e;color:white;border:2px solid #17294e;padding:5px 15px;text-align:center;text-decoration:none;display:inline-block"
                                   href="https://bitex.com/user-wallet"> Deposit Now </a>.
                                </td>
                              </tr>
                              <tr>
                                <td align="center" style="font-size:0px;padding:0px;word-break:break-word;">
                                  <div style="font-family:Lato, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:center;color:#535353;"><a href="https://support.bitex.com/support/solutions/articles/48001141187-how-to-deposit-fiat-currency-inr-usd-aed-into-my-account-" style="text-decoration:none;color:#17294E;font-size:16px;font-weight:700;line-height:22px;">Click here </a> to know how to deposit funds in Bitex account.</div>
                                </td>
                              </tr>
                            </table>
                          </td>

module.exports = function unVerifyUsersEmail() {
  return `<!doctype html>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                            ...
                            <tr>
                              ...
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Lato, sans-serif;font-size:16px;font-weight:500;line-height:28px;text-align:left;color:#535353;">Now you can get your account verified in just 30 seconds. All you need to do is fill all the required details and upload the documents and the system will authenticate the account instantly.</div>
                              </td>
                            </tr>
                          </table>
                        </td>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                            <tr>
                              <td align="center" style="font-size:0px;padding:0px;word-break:break-word;">
                                <div style="font-family:Lato, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:center;color:#535353;">
                                Please click on the below link for verify the account
                              </td>
                            </tr>
                            <tr>
                              <td align="center" style="word-break:break-word;">
                                <a style="margin: 10px 10px 10px 10px;font-size:15px;background-color:#17294e;color:white;border:2px solid #17294e;padding:5px 15px;text-align:center;text-decoration:none;display:inline-block"
                                 href="https://bitex.com/user-wallet"> Verify Now </a>.
                              </td>
                            </tr>
                            <tr>
                              <td align="center" style="font-size:0px;padding:0px;word-break:break-word;">
